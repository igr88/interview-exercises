...
class Priorities {
    public List<Student> getStudents(List<String> events) {
        ...
        for (String event : events) {
            if (event.startsWith("ENTER")) {
                Student student = buildStudent(event);
                students.add(student);
            } else {
                serveStudents(students);
            }
        }
    ...
    private List<Student> serveStudents(List<Student> students) {
        if (students.isEmpty()) {
            return students;
        }
    ...
    private Student buildStudent(String event) {
...
public class PriorityQueue {
    ...
    public static void main(String[] args) {
        ...
        var students = priorities.getStudents(Arrays.asList(names));
